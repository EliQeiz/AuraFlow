...
export default function Blog() {
    ...
    () =>
      posts.filter((post) => {
        const filterCategory =
          ...
          (category === 'Dev Tips' && post.category === 'Firebase')
        const terms =
  ...
  return (
    <PageWrapper>
      <SEOHead
        title="Blog"
        description="AuraFlow notes on development, design, Firebase, mobile products, AI, business, and case studies."
        image={IMAGES.blog.default}
      />
      <section className="relative overflow-hidden py-20">
        <img
          src={IMAGES.blog.default}
          alt=""
        ...
        <div className="section-shell relative">
          <Badge>Blog</Badge>
          <h1 className="mt-5 max-w-4xl text-4xl font-extrabold sm:text-6xl">
            Build notes for digital teams that need to ship.
          </h1>
          <label className="relative mt-7 block max-w-xl">
            ...
            <Input
              ...
              className="bg-aura-dark/75 pl-9"
            />
          </label>
        </div>
      </section>
            ...
            <Card key={post.id} className="group overflow-hidden">
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <p className="mt-2 line-clamp-3 text-aura-muted">
                    {post.excerpt}
                  </p>
