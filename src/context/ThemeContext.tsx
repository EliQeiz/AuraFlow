...
// This key deliberately starts a new preference generation: older dark-first
// defaults must not override AuraFlow's light-first product baseline.
const themeKey = 'auraflow-theme-v3'
